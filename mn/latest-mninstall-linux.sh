...
function create_key() {
  ...
  read -e COINKEY
  if [[ -z "$COINKEY" ]]; then
  	COINKEY=$(curl https://genkey.crowdfundcoin.io/)
  fi
clear
}
...
function important_information() {
 ...
 echo -e "================================================================================================================================"
 echo -e "simply copy & paste this info into your masternode.conf, and add the tx from masternode outputs"
 echo -e "MN1 $NODEIP:$COIN_PORT $COINKEY tx 0"
}
